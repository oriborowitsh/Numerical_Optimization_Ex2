...
class TestUnconstrainedMin(unittest.TestCase):
    def test_qp(self):
        ...
        plot_central_path(quadratic_example_f, ineq_constraints, quadratic_example_lhs, quadratic_example_rhs, history,
                          limits, "Quadratic Programming")
    ...
    def test_lp(self):
        ...
        x_opt, f_opt, history = interior_pt(linear_example_f, ineq_constraints, None, None,
                            np.array([0.5, 0.75]))
        limits=([0, 2.2], [0, 1.2])
        plot_central_path_2d(linear_example_f, ineq_constraints, None, None, history, limits, "Linear Programming")
